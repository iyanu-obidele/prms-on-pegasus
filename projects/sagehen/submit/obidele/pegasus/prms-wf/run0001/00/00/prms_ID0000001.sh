...
# execute the tasks
set +e
pegasus-kickstart -n prms -N ID0000001 -o prms.output -R condorpool  -L prms-wf -T 2017-03-16T16:46:00-07:00 /u/obidele/PERF/PROJ/prms4.0.2_src/projects/sagehen/prms -C sagehen.control
job_ec=$?
set -e
