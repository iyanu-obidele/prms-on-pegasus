...
# execute the tasks
set +e
pegasus-kickstart -n prms -N ID0000001 -R condorpool  -s sagehen.control=sagehen.control -L process -T 2017-03-16T13:07:44-07:00 /u/obidele/PERF/PROJ/prms4.0.2_src/projects/sagehen/prms -C sagehen.control
job_ec=$?
set -e
