...
# execute the tasks
set +e
pegasus-kickstart -n prms -N ID0000001 -R condorpool  -s control/sagehen.control=control/sagehen.control -L process -T 2017-03-15T22:28:41-07:00 ./prms -C control/sagehen.control
job_ec=$?
set -e
