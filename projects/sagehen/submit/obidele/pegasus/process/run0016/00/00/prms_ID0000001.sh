...
# execute the tasks
set +e
pegasus-kickstart -n prms -N ID0000001 -o prmsRes.txt -R condorpool  -L process -T 2017-03-16T15:52:52-07:00 /u/obidele/PERF/PROJ/prms4.0.2_src/projects/sagehen/prms -C sagehen.control
job_ec=$?
set -e
